...
// ── semente ──────────────────────────────────────────────────
t("semente tem 192 insumos", () => eq(INSUMOS_SEED.length, 192));
...
t("semente tem 175 materiais e 17 prestadores", () => {
...
// ── semeadura ────────────────────────────────────────────────
t("semeadura em base vazia cria os 192", () => {
  const r = semearInsumos([], INSUMOS_SEED);
  eq(r.criados, 192);
  eq(r.materiais.length, 192);
});
