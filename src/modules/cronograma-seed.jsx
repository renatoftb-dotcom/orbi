...
// `receita`: composições SINAPI e fatores que geram `horas` (Σ f × horas da
// composição, com ajudantes em servente) — é o que scripts/atualizar-sinapi.mjs
// recalcula a cada atualização; null = somado à mão (paramétrica sem
// sub-composições publicadas), atualizar manualmente.
var PRODUTIVIDADE_SEED = {
  ESCAVACAO:      { nome: "Escavação manual de valas",                 unidade: "m³", fonte: "SINAPI 93358",  horas: { servente: 3.956 }, receita: [{ c: "93358", f: 1 }] },
  BROCA:          { nome: "Estaca broca Ø20 cm (escavação manual)",     unidade: "m",  fonte: "SINAPI 101173", horas: { pedreiro: 0.486, servente: 0.665 }, receita: [{ c: "101173", f: 1 }] },
  CONCRETO:       { nome: "Concreto em betoneira, lançamento e adensamento", unidade: "m³", fonte: "SINAPI 94965 + 103670", horas: { pedreiro: 2.459, servente: 11.152, carpinteiro: 2.459 }, receita: [{ c: "94965", f: 1 }, { c: "103670", f: 1 }] },
  ARMACAO:        { nome: "Armação CA-50 (corte, dobra e montagem)",     unidade: "kg", fonte: "SINAPI 92761 + 92802", horas: { armador: 0.072, servente: 0.012 }, receita: [{ c: "92761", f: 1 }, { c: "92802", f: 1 }] },
  FORMA:          { nome: "Fôrma de madeira (fabricação, montagem, desmontagem)", unidade: "m²", fonte: "SINAPI 92415 + 92263", horas: { carpinteiro: 1.745, servente: 0.337 }, receita: [{ c: "92415", f: 1 }, { c: "92263", f: 0.525 }] },
  ALVENARIA:      { nome: "Alvenaria de vedação em tijolo cerâmico",     unidade: "m²", fonte: "SINAPI 103328", horas: { pedreiro: 1.61, servente: 0.805 }, receita: [{ c: "103328", f: 1 }] },
  VERGAS:         { nome: "Vergas e contravergas pré-moldadas",          unidade: "m",  fonte: "SINAPI 93184/93194", horas: { pedreiro: 0.054, servente: 0.141, carpinteiro: 0.032 }, receita: [{ c: "93184", f: 0.5 }, { c: "93194", f: 0.5 }, { c: "94964", f: 0.021 }, { c: "92270", f: 0.0405 }] },
  LAJE:           { nome: "Laje pré-moldada treliçada (montagem, armação da capa, concretagem)", unidade: "m²", fonte: "SINAPI 101951", horas: { carpinteiro: 0.53, servente: 0.418, pedreiro: 0.057, armador: 0.128 }, receita: [{ c: "101951", f: 1 }, { c: "103674", f: 0.051 }, { c: "92767", f: 1.211 }, { c: "92273", f: 1.16 }] },
  CHAPISCO_INT:   { nome: "Chapisco interno",                            unidade: "m²", fonte: "SINAPI 87879",  horas: { pedreiro: 0.068, servente: 0.026 }, receita: [{ c: "87879", f: 1 }] },
  CHAPISCO_EXT:   { nome: "Chapisco de fachada",                         unidade: "m²", fonte: "SINAPI 87905",  horas: { pedreiro: 0.172, servente: 0.058 }, receita: [{ c: "87905", f: 1 }] },
  REBOCO_INT:     { nome: "Reboco / massa única interna",                unidade: "m²", fonte: "SINAPI 87529",  horas: { pedreiro: 0.472, servente: 0.236 }, receita: [{ c: "87529", f: 1 }] },
  REBOCO_EXT:     { nome: "Reboco / massa única de fachada",             unidade: "m²", fonte: "SINAPI 87775",  horas: { pedreiro: 0.679, servente: 0.679 }, receita: [{ c: "87775", f: 1 }] },
  CONTRAPISO:     { nome: "Contrapiso em argamassa",                     unidade: "m²", fonte: "SINAPI 87620",  horas: { pedreiro: 0.214, servente: 0.107 }, receita: [{ c: "87620", f: 1 }] },
  CALCADA:        { nome: "Piso de concreto / calçada externa",          unidade: "m²", fonte: "SINAPI 94992 + 94964", horas: { pedreiro: 0.148, servente: 0.552, carpinteiro: 0.098 }, receita: [{ c: "94992", f: 1 }, { c: "94964", f: 0.0739 }] },
  IMPERM_BALDRAME: { nome: "Impermeabilização de baldrame (emulsão asfáltica, 2 demãos)", unidade: "m²", fonte: "SINAPI 98557", horas: { impermeabilizador: 0.43, servente: 0.097 }, receita: [{ c: "98557", f: 1 }] },
  IMPERM_MANTA:   { nome: "Impermeabilização com manta asfáltica",       unidade: "m²", fonte: "SINAPI 98546",  horas: { impermeabilizador: 0.932, servente: 0.21 }, receita: [{ c: "98546", f: 1 }] },
  MADEIRAMENTO:   { nome: "Estrutura de madeira do telhado",             unidade: "m²", fonte: "SINAPI 92539",  horas: { carpinteiro: 0.527, servente: 0.546 }, receita: [{ c: "92539", f: 1 }] },
